...
def get_safe_seed(seed: Any, bit_length: int) -> int:
    ...
    :type bit_length: int
    :returns: A number safe to be used with :mod:`numpy.random` functions.
